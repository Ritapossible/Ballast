...
| `bitget-signal` research Skills | ❌ **not used** — perception is the Nasdaq earnings calendar plus Google News RSS, built before this toolchain was surveyed. The handbook suggests these Skills for the AI Trading Desk track's perception layer. Adding them now would change no decision on the record: the last decide run before the deadline has already happened. |
