...
and commits unattended, and a public site with full documentation. **356 tests, network-free
and key-free.**
...
| **Tests** | `python3 -m unittest discover -s tests` - 356, network-free, incl. 31 end-to-end |
