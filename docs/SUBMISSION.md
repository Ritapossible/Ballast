...
and commits unattended, and a public site with full documentation. **411 tests, network-free
and key-free.**
...
| **Tests** | `python3 -m unittest discover -s tests` - 411, network-free, incl. 31 end-to-end |
