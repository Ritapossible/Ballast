...
**The mechanism.** Of 2,587 live rTokens, **235 have a matched stock perpetual** trading the
...
positions it *cannot* protect: **2,352 of 2,587 rTokens have no perp leg.**
...
and commits unattended, and a public site with full documentation. **498 tests, network-free
and key-free.**
...
| **Tests** | `python3 -m unittest discover -s tests` - 498, network-free, incl. 31 end-to-end |
