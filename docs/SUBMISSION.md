...
**The mechanism.** Of 2,125 live rTokens, **226 have a matched stock perpetual** trading the
...
intact. **25 red-team tests** drive hostile intents at it, each asserting the specific rule
that refused it.
...
positions it *cannot* protect: **1,899 of 2,125 rTokens have no perp leg.**
...
and commits unattended, and a public site with full documentation. **427 tests, network-free
and key-free.**
...
| **Tests** | `python3 -m unittest discover -s tests` - 427, network-free, incl. 31 end-to-end |
