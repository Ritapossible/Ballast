...
**The mechanism.** Of 2,125 live rTokens, **229 have a matched stock perpetual** trading the
...
positions it *cannot* protect: **1,896 of 2,125 rTokens have no perp leg.**
...
and commits unattended, and a public site with full documentation. **471 tests, network-free
and key-free.**
...
| **Tests** | `python3 -m unittest discover -s tests` - 471, network-free, incl. 31 end-to-end |
