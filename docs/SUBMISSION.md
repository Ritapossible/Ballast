...
and commits unattended, and a public site with full documentation. **469 tests, network-free
and key-free.**
...
| **Tests** | `python3 -m unittest discover -s tests` - 469, network-free, incl. 31 end-to-end |
